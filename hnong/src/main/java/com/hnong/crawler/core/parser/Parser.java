package com.hnong.crawler.core.parser;

import com.hnong.crawler.exception.ParserException;
    ...
    public T parser(Document doc, Class clazz) throws ParserException {
        ...
        for (Field f : fields) {
            ...
            if (tag.tagType().equals(Tag.TYPE.TEXT)) {
                ...
                } else if (!StringUtil.isBlank(tClazz)) {
            ...
            if (StringUtil.isBlank(value) && required) {
