...
public class CommonSpider extends Spider {
    ...
    @Override
    public String download(String url, String encoding, String cookies) throws IOException, com.hnong.crawler.exception.SpiderException {
        HttpURLConnection httpConn = getConnection(url);
...
//        httpConn.setRequestProperty("Host", "xjh.haitou.cc");
    ...
    private String get(HttpURLConnection httpConn, String encoding) throws com.hnong.crawler.exception.SpiderException, IOException {
        try {
            ...
            if (status == CrawlerConstant.CONNECTION_OK) {
                ...
                throw new com.hnong.crawler.exception.SpiderException("download url get failed response code.");
            }
        } catch (IOException e) {
            throw new IOException();
        }
