package com.hnong.common.util;

import com.hnong.common.util.constants.UserConstant;
...
public class StringUtil extends StringUtils {
    ...
    private static final Pattern PHONE_NUMBER_PATTERN = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(18[0-9])|(14[5,7]))\\d{8}$");
    ...
    public static String getFormHash(Integer uid) {
        String code = (System.currentTimeMillis() + "").substring(0, 3) + "|" + uid + "|" + StringUtil.md5(UserConstant.UCHOME_AUTH_SITEKEY) + "|";
